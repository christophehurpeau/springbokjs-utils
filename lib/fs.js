...
var promisesUtils = _interopRequireWildcard(require("./promises"));
...
var readJsonFile = exports.readJsonFile = function () {
  return exports.readFile.apply(exports, arguments).then(JSON.parse);
};
 ...
 * @return {*}
 */
var readJsonFileSync = exports.readJsonFileSync = function () {
  var result = fs.readFileSync.apply(fs, arguments);
  return result && JSON.parse(result);
};

var writeJsonFile = exports.writeJsonFile = function () {
  var args = arguments;
  args[1] = JSON.stringify(args[1]);
  return exports.writeFile.apply(exports, args);
};

var writePrettyJsonFile = exports.writePrettyJsonFile = function () {
  var args = arguments;
 ...
 * @return {Promise}
 */
var readYamlFile = exports.readYamlFile = function () {
  return exports.readFile.apply(exports, arguments).then(parseYaml);
};
 ...
 * @return {*}
 */
var readYamlFileSync = exports.readYamlFileSync = function () {
  var result = fs.readFileSync.apply(fs, arguments);
 ...
 * @return {*}
 */
var writeYamlFile = exports.writeYamlFile = function () {
  var args = arguments;
 ...
 * @return {Promise}
 */
var readRecursiveDirectory = exports.readRecursiveDirectory = function readRecursiveDirectory(dir, options, callback) {
  options = Object.assign({
    recursive: true,
    directories: false }, options);
  return exports.readdir(dir).then(function (files) {
    return promisesUtils.forEach(files, function (file) {
      var path = dir + "/" + file;
