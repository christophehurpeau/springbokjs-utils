 ...
 */
var daysInMonth = exports.daysInMonth = function (month, year) {
    if (month === 1) {
 ...
 */
var toSqlDate = exports.toSqlDate = function (date, withHours) {
 ...
 * @return {Date} date
 */
var parseSqlDate = exports.parseSqlDate = function (date) {
    date = date.split(" ");
    date[0] = date[0].split("-");
    if (date.length === 2) {
        date[1] = date[1].split(":");
