...
test('strip tags should strip the tags', function() {
    expect(stringUtils.stripTags('<p>Kevin</p> <br /><b>van</b> <i>Zonneveld</i><br>', 'i b'),
        'Kevin\n<b>van</b> <i>Zonneveld</i>');
    expect(stringUtils.stripTags('<p>Kevin <img src="someimage.png" onmouseover="someFunction()">van <i>Zonneveld</i></p>', 'p'),
